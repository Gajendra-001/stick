    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('USER', 'Visually Impaired User'), ('GUARDIAN', 'Guardian/Caretaker'), ('ADMIN', 'Administrator')], default='USER', max_length=10)),
                ...
                ('visual_impairment_level', models.CharField(blank=True, choices=[('MILD', 'Mild Visual Impairment'), ('MODERATE', 'Moderate Visual Impairment'), ('SEVERE', 'Severe Visual Impairment'), ('BLIND', 'Blind')], max_length=10, null=True)),
